...
%**************************************************************************
% methodMean = {'riemann','arithmetic','logeuclid','ld','opttransp', 'sdivergence', 'harmonic', 'geometric'};
% methodDist = {'riemann','euclid','logeuclid','ld','opttransp', 'sdivergence', 'euclid', 'euclid'};
methodMean = {'arithmetic','harmonic','riemann','logeuclid','kullback','sdivergence','ld','bhat','opttransp'};
methodDist = {'euclid','harmonic','riemann','logeuclid','kullback','sdivergence','ld','bhat','opttransp'};
tLen = 4;
delay = 2;
...
%             if strcmp(methodMean{method}, 'riemann')
%                 
%             end
...
impr = ((resMatrix(:,3,3) - resMatrix(:,3,1))./resMatrix(:,3,1))*100;

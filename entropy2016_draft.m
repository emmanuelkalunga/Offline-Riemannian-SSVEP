...
% methodMean = {'arithmetic','harmonic','riemann','logeuclid','kullback','sdivergence','ld','bhat','wasserstein'};
% methodDist = {'euclid','harmonic','riemann','logeuclid','kullback','sdivergence','ld','bhat','wasserstein'};
methodMean = {'kullback','mahalanobis'};
methodDist = {'kullback','mahalanobis'};
